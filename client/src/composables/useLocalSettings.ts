...
const defaults: LocalSettings = { kioskInterval: 10, heartbeatTimeoutSec: 120, autoStart: false, logToFile: true, logCapMB: 1024, anomalyEffect: false, highQuality: false };
